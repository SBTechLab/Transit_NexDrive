...
export default function Sidebar() {
  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-gradient-to-b from-slate-950 via-[#0f1729] to-slate-950 text-slate-300 border-r border-slate-800/50 shadow-2xl">
      {/* Logo */}
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-gradient-to-r from-blue-600/25 to-violet-600/15 text-white border border-blue-500/25 shadow-sm shadow-blue-500/10'
